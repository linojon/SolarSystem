...
/**
 * Created by Jonathan on 12/17/2015.
 */
public class Sphere extends RenderObject{
    ...
    public static void allocateBuffers(){
        ...
        //TODO: add parameters to constructor and/or buffer function to allow for variable LOD spheres
        float radius = 1f;
        // Longitude |||
        int nbLong = 24;
        // Latitude ---
        ...
        for( int lat = 0; lat < nbLat; lat++ )
        {
            ...
            for( int lon = 0; lon <= nbLong; lon++ )
            {
                ...
                vertices[lon + lat * (nbLong + 1) + nbLong] = new Vector3( sin1 * cos2, cos1, sin1 * sin2 ).multiply(radius);
            }
        }
...
//Bottom Cap
        ...
        //TODO: Utility function to convert Vector3[] to float[]
